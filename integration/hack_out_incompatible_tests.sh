...
sed -i '' '62s/assert %Decimal{} = TestRepo.aggregate(Post, :avg, :visits)/assert "12.5" <> _ = to_string(TestRepo.aggregate(Post, :avg, :visits))/' deps/ecto/integration_test/cases/repo.exs
