defmodule Sqlite.Ecto.Mixfile do
  ...
  defp deps do
    [{:backoff, git: "https://github.com/scouten/backoff.git", ref: "8f10cb83b5fbc2401e6a06b341417cad4c632f34", override: true},
     ...
     {:db_connection, "1.0.0", optional: true, override: true},
     ...
     {:ecto, git: "https://github.com/elixir-ecto/ecto.git", ref: "fbbf12df71692ccd2d687de7982ca59ecae23d32"},
     {:poison, "2.2.0", override: true, optional: true},
     {:postgrex, "0.12.0", optional: true, override: true},
     {:sbroker, "~> 1.0", override: true},
     {:sqlitex, git: "https://github.com/scouten/sqlitex.git", ref: "109f7beeb6ca98f76c73b6faf16e85c3a2f88cff", override: true}]
  end
